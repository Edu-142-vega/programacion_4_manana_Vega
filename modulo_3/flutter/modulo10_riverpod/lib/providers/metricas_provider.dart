...
class MetricasNotifier extends AsyncNotifier<List<MetricaServidor>> {
  ...
  Future<List<MetricaServidor>> _fetch() async {
    ...
    return const [
      MetricaServidor(servidor:'prod-web-01', cpu:45.2, ram:62.1, ssd: 20.0, conexiones:230),
      MetricaServidor(servidor:'prod-db-01',  cpu:88.1, ram:91.2, ssd: 250.0, conexiones:80),
      MetricaServidor(servidor:'staging-api', cpu:22.4, ram:41.0, ssd: 250.0, conexiones:50),
    ];
  }
