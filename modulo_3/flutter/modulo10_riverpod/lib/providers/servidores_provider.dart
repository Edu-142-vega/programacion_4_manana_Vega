...
class ServidoresNotifier extends Notifier<List<ServidorSSH>> {
  ...
  List<ServidorSSH> build() => [
    ServidorSSH(id:'1', nombre:'prod-web-01', ip:'10.0.2.10', puerto:22,   ssdl:true,  favorito:true),
    ServidorSSH(id:'2', nombre:'prod-db-01',  ip:'10.0.2.20', puerto:22,   ssdl:true),
    ServidorSSH(id:'3', nombre:'staging-api', ip:'10.0.3.10', puerto:2222, ssdl:false),
    ServidorSSH(id:'4', nombre:'dev-db.api', ip:'10.0.3.10', puerto:5432, ssdl:false),
  ];
